...
@section('content')
	<h4>
		...
		<a href="{{ URL::to('usuario/create') }}" class="btn btn-primary navbar-right"><span class="glyphicon glyphicon-plus-sign"></span> Novo</a>
	</h4>
	<hr>
		...
		<table class="table table-striped table-hover">
			<thead>
				<tr>
					...
					<th><a href="{{ URL::to('usuario?sort=updated_at' . $str) }}">Alterado</a></th>
					<th colspan="2"></th>
				</tr>
			</thead>
			<tbody>
				@foreach ($usuarios as $usuario)
					<tr>
						...
						<td class="action">{{ link_to('usuario/' . $usuario->id . '/edit', 'Editar', array('class' => 'btn btn-warning btn-sm', 'title' => 'Editar')) }}</td>
						<td class="action">
