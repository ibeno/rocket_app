...
@section('content')
	<h4>
		...
		<a href="{{ URL::to('veiculo/create') }}" class="btn btn-primary navbar-right"><span class="glyphicon glyphicon-plus-sign"></span> Novo</a>
	</h4>
	<hr>
			...
			<tbody>
				@foreach ($veiculos as $veiculo)
					<tr>
						...
						<td class="action">{{ link_to('veiculo/' . $veiculo->id, 'Detalhar', array('class' => 'btn btn-primary btn-sm', 'title' => 'Detalhar')) }}</td>
						<td class="action">{{ link_to('veiculo/' . $veiculo->id . '/edit', 'Editar', array('class' => 'btn btn-warning btn-sm', 'title' => 'Editar')) }}</td>
						<td class="action">
